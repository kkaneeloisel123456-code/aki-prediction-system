...
| 指标 | 数值 |
|------|------|
| **5折×10次=50次CV AUC** | **0.821 ± 0.043** |
| 测试集 AUC | 0.799 |
| Bootstrap AUC (1000次) | 0.822 [0.779, 0.865] |
| 过拟合差距 | 0.128（可接受范围，<0.15） |
...
| **最终版（+术后早期）** | **0.82** | **5折×10次=50次CV** | **当前最优，过拟合可控** |
...
| **亚组分析** | 按风险/肾功能分层评估 | 高风险组AKI率56.2%，低风险组3.3%（约17倍差距） |
| **VIF共线性诊断** | 方差膨胀因子检验 | 肾功能相关指标天然相关，RF筛选+L2正则化已处理 |
...
| 维度 | 方法 |
|------|------|
| **区分度** | AUC-ROC, Precision-Recall AUC, 5折×10次=50次CV, Bootstrap 95%CI |
